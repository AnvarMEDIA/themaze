...
export function BriefForm() {
  ...
  const NavButtons = ({ isSubmit = false }: { isSubmit?: boolean }) => (
  ...
  const Step1 = () => (
    <div className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="label-sm text-maze-muted block mb-2">{t('fields.name')} *</label>
          <input
        ...
        <div>
          <label className="label-sm text-maze-muted block mb-2">{t('fields.email')} *</label>
          <input
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="label-sm text-maze-muted block mb-2">{t('fields.phone')}</label>
          <PhoneInput
            international defaultCountry="UZ" flags={flags}
        ...
        <div>
          <label className="label-sm text-maze-muted block mb-2">{t('fields.company')}</label>
          <input
      ...
      <div>
        <label className="label-sm text-maze-muted block mb-2">{t('fields.website')}</label>
        <input
  ...
  const Step2 = () => (
    <div className="space-y-7">
      ...
      <div>
        <label className="label-sm text-maze-muted block mb-2">{t('fields.description')} *</label>
        <textarea
          required rows={5} placeholder={t('fields.descriptionPlaceholder')}
      ...
      <div>
        <label className="label-sm text-maze-muted block mb-2">{t('fields.goals')}</label>
        <textarea
          rows={3} placeholder={t('fields.goalsPlaceholder')}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="label-sm text-maze-muted block mb-2">{t('fields.audience')}</label>
          <textarea
            rows={3} placeholder={t('fields.audiencePlaceholder')}
            value={form.audience} onChange={(e) => set('audience', e.target.value)}
            className={inputClass + ' resize-none'}
          />
        </div>
        <div>
          <label className="label-sm text-maze-muted block mb-2">{t('fields.competitors')}</label>
          <textarea
            rows={3} placeholder={t('fields.competitorsPlaceholder')}
  ...
  const Step3 = () => (
    <div className="space-y-10">
      ...
      {/* Reference links */}
      <div>
        <label className="label-sm text-maze-muted block mb-2">{t('fields.refLinks')}</label>
        <textarea
          rows={3} placeholder={t('fields.refLinksPlaceholder')}
  ...
  const Step4 = () => (
    <form onSubmit={handleSubmit} noValidate>
      ...
      <div className="space-y-7">
        ...
        {/* Source */}
        <div>
          <label className="label-sm text-maze-muted block mb-2">{t('fields.source')}</label>
          <input
            type="text" placeholder={t('fields.sourcePlaceholder')}
        ...
        {/* Notes */}
        <div>
          <label className="label-sm text-maze-muted block mb-2">{t('fields.notes')}</label>
          <textarea
            rows={4} placeholder={t('fields.notesPlaceholder')}
  ...
  const stepMeta = [
    t(`step1.heading`), t(`step2.heading`), t(`step3.heading`), t(`step4.heading`),
  ]
  const stepSub = [
    t(`step1.sub`), t(`step2.sub`), t(`step3.sub`), t(`step4.sub`),
  ]
  ...
  return (
    <div>
      <Progress />
      <div className="mb-8">
        <h2 className="heading-lg text-maze-cream mb-1">{stepMeta[step - 1]}</h2>
        <p className="body-lg text-maze-muted">{stepSub[step - 1]}</p>
      </div>
