    ...
    <div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-10">
        ...
        <div className="flex gap-1 border border-maze-border rounded-full p-1">
          ...
          >
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <rect x="0" y="1"  width="14" height="2" fill="currentColor" rx="1"/>
              <rect x="0" y="6"  width="14" height="2" fill="currentColor" rx="1"/>
              <rect x="0" y="11" width="14" height="2" fill="currentColor" rx="1"/>
            </svg>
          </button>
        </div>
      </div>
